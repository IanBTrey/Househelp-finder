...
def index():
    ...
    title = 'The Houselps-finder webbApp'
...
def new_blog():
    ...
    if form.validate_on_submit():
        ...
        for subscriber in subscribers:
            ...
            mail_message("New Search Alert!!", "email/new_blog", subscriber.email)
            mail_message("New Search Notice!!","email/new_blog",subscriber.email, subscriber=subscriber)
...
def see_blogs(id):
    ...
    title = 'Welcome to The Houselps-finder webbApp'
...
def subscribe():
    ...
    if form.validate_on_submit():
        ...
        mail_message("Welcome to The Houselps-finder webbApp","email/subscribe_user",subscriber.email,subscriber=subscriber)
